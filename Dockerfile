...
RUN apt-get install -y --no-install-recommends \
    ...
    ant clinfo vulkan-tools mesa-vulkan-drivers dkms freeglut3-dev git intel-gpu-tools intel-opencl-icd libegl1-mesa-dev libgl1-mesa-dev libgles2-mesa-dev libglvnd-dev libsdl1.2-dev lm-sensors mesa-opencl-icd mesa-utils ocl-icd-libopencl1 ocl-icd-opencl-dev opencl-headers openjdk-21-jdk pkg-config python3-pip python3-setuptools qv4l2
